 ...
 *
 * It is deliberately a flat-identity-geometry stand-in: enough for the binding's
 * harness test to drive a real bpmn-js viewer headlessly and assert that markers
 * and overlays land on the real canvas. Test-only; lives outside `src/`.
 *
